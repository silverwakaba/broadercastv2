    ...
    <x-Adminlte.Content>
        <x-Adminlte.Callout class="info">
            ...
            <ol class="m-0">
                ...
                <li>The settings below are not tied to an account, instead it will only be saved in the cache of local browser and are valid for one month.</li>
                <li>The settings below MAY NOT APPLY if you open the {{ config('app.name', 'vTual') }} on a new browser or within the next month when the cache has expired.</li>
            </ol>
        </x-Adminlte.Callout>
