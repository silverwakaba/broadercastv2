...
@section('content')
    <x-Adminlte.Content>
        <div class="row row-cols-1 row-cols-lg-2">
            ...
            <div class="col">
                <x-Adminlte.Box colors="bg-dark" icon="fas fa-at" title="Email" content="Change your email." :link="route('apps.manager.email')" />
            </div>
            <div class="col">
            ...
            <div class="col">
                <x-Adminlte.Box colors="bg-dark" icon="fas fa-user-tag" title="Handler" content="Manage your link identifier." :link="route('apps.manager.handler')" />
            </div>
            <div class="col">
            ...
            <div class="col">
                <x-Adminlte.Box colors="bg-dark" icon="fas fa-link" title="Link" content="Manage your external link." :link="route('apps.manager.link')" />
            </div>
            <div class="col">
                <x-Adminlte.Box colors="bg-dark" icon="fas fa-unlock-alt" title="Password" content="You can change your password here." :link="route('apps.manager.password')" />
            </div>
            <div class="col">
