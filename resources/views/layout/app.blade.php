...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{ config('app.cdn_static_url') . '/system/image/logo/broadercast/logo-100px.png' }}">
    ...
    <body @class(["hold-transition", "layout-fixed", "dark-mode", "sidebar-mini" => request()->routeIs('apps.*'), "layout-top-nav" => !request()->routeIs('apps.*')])>
        <div class="wrapper">
            <x-Adminlte.Main />
        </div>
